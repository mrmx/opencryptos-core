package org.opencryptos.core.coins.nxt;
...
//                + " existing key " + com.openwallet.core.coins.nxt.Convert.toHexString(account.getPublicKey()) + " new key " + com.openwallet.core.coins.nxt.Convert.toHexString(publicKey));
//    }
...
//        if (id != com.openwallet.core.coins.nxt.Crypto.rsDecode(com.openwallet.core.coins.nxt.Crypto.rsEncode(id))) {
...
//        name = com.openwallet.core.coins.nxt.Convert.emptyToNull(name.trim());
//        description = com.openwallet.core.coins.nxt.Convert.emptyToNull(description.trim());
...
//            data = com.openwallet.core.coins.nxt.Convert.compress(data);
//        }
//        return EncryptedData.encrypt(data, com.openwallet.core.coins.nxt.Crypto.getPrivateKey(senderSecretPhrase), getPublicKey());
//    }
//
...
//        }
//        byte[] decrypted = encryptedData.decrypt(com.openwallet.core.coins.nxt.Crypto.getPrivateKey(recipientSecretPhrase), getPublicKey());
//        if (uncompress && decrypted.length > 0) {
//            decrypted = com.openwallet.core.coins.nxt.Convert.uncompress(decrypted);
//        }
//        return decrypted;
//    }
//
